...
public class Log {
    ...
    private static LogFile infoLogFile = null;
    private static LogFile errorLogFile = null;

    public static void init(String infoLogPath, String errorLogPath){

        infoLogFile = new LogFile(infoLogPath);
        errorLogFile = new LogFile(errorLogPath);
    }
